  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 text-left">
      ...
      <div className="p-6 bg-slate-900 border border-slate-800 rounded-2xl text-slate-300 text-sm leading-relaxed space-y-6">
        <section>
          <h3 className="text-lg font-bold text-white mb-2">About Date Difference Calculator</h3>
          <p>
            Easily measure the exact duration in days between any two calendar dates. 
            This utility helps plan event timelines, calculate project deadlines, or track duration milestones accurately.
          </p>
        </section>
        ...
        <section>
          ...
          <ol className="list-decimal list-inside space-y-1.5 text-slate-400">
            <li>Select your starting calendar date from the <strong className="text-slate-200">Start Date</strong> picker.</li>
            <li>Select your ending target date from the <strong className="text-slate-200">End Date</strong> picker.</li>
            <li>Click <strong className="text-slate-200">Calculate Difference</strong> to display total elapsed days.</li>
          </ol>
        </section>
        ...
        <section>
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                Yes, JavaScript Date objects handle leap years and differing month lengths automatically.
              </p>
            </div>
          </div>
        </section>
