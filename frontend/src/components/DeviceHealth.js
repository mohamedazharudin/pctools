  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 text-left">
      ...
      <div className="p-6 bg-slate-900 border border-slate-800 rounded-2xl text-slate-300 text-sm leading-relaxed space-y-6">
        <section>
          <h3 className="text-lg font-bold text-white mb-2">About System Health Checker</h3>
          <p>
            This tool inspects your device hardware status directly through browser APIs. 
            It evaluates critical performance indicators such as available processor cores, system memory, battery levels, network speeds, and local storage limits.
          </p>
        </section>
