    ...
    <div className="max-w-6xl mx-auto text-left space-y-6 sm:space-y-8 overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row gap-5">
        ...
        <div className="w-full lg:flex-1 bg-slate-900 p-4 sm:p-5 rounded-2xl shadow-xl border border-slate-800 text-white">
          ...
          <p className="text-slate-400 text-xs sm:text-sm mb-4">Fill out your details to generate your resume instantly.</p>
        ...
        <div className="w-full lg:flex-1 overflow-x-auto">
          <div id="printable-resume" className="bg-white p-5 sm:p-10 rounded-2xl shadow-xl border border-slate-200 min-h-[500px] text-slate-900 break-words">
            ...
            {/* Header Section */}
            <div className="mb-6">
              <h1 className="m-0 mb-2 text-slate-900 text-2xl sm:text-3xl font-bold break-words">{personal.name || 'Your Name'}</h1>
              <h3 className="text-blue-600 m-0 mb-2 text-base sm:text-lg font-semibold break-words">{personal.title || 'Job Title'}</h3>
            ...
            <div className="mb-6 sm:mb-8">
              <h3 className="text-slate-800 mb-3 uppercase text-sm sm:text-base tracking-wider font-semibold">Skills</h3>
            ...
            {/* Experience Section */}
            <div className="mb-6 sm:mb-8">
              <h3 className="text-slate-800 mb-3 sm:mb-4 uppercase text-sm sm:text-base tracking-wider font-semibold">Work Experience</h3>
            ...
            {/* Education Section */}
            <div className="mb-5">
              <h3 className="text-slate-800 mb-3 sm:mb-4 uppercase text-sm sm:text-base tracking-wider font-semibold">Education</h3>
      ...
      <div className="p-4 sm:p-6 bg-slate-900 border border-slate-800 rounded-2xl text-slate-300 text-xs sm:text-sm leading-relaxed space-y-4 sm:space-y-6">
        <section>
          <h3 className="text-base sm:text-lg font-bold text-white mb-2">About the Online Resume Builder</h3>
          <p>
            Creating a professional, well-formatted resume is essential for job applications. This interactive online builder formats your personal details, work experience, education, and technical skills into a clean document ready to export or print as a PDF.
          </p>
        </section>

        <section>
          <h3 className="text-sm sm:text-base font-semibold text-white mb-2">How to Build Your Resume</h3>
          <ol className="list-decimal list-inside space-y-1.5 text-slate-400">
            ...
            <li>
              Review the live preview on the right and click <strong className="text-slate-200">Download / Print PDF</strong> to export.
            </li>
          </ol>
        </section>

        <section>
          <h3 className="text-sm sm:text-base font-semibold text-white mb-2">Frequently Asked Questions</h3>
