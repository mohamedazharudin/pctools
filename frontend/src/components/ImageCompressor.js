    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="p-6 bg-slate-900 border border-slate-800 rounded-2xl text-slate-300 text-sm leading-relaxed space-y-6 text-left">
        <section>
          ...
          <p>
            Large image files can slow down website loading speeds and use up storage. This client-side Image Compressor reduces file size by tweaking JPG/JPEG quality settings using HTML5 Canvas—all directly inside your web browser.
          </p>
        </section>
