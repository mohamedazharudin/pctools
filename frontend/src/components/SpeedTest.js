    ...
    <div className="max-w-2xl mx-auto space-y-8 text-left">
      ...
      <div className="p-6 bg-slate-900 border border-slate-800 rounded-2xl text-slate-300 text-sm leading-relaxed space-y-6">
        <section>
          ...
          <p>
            This tool measures your real-time download bandwidth by fetching a sample data file from a fast content delivery network. 
            Checking your internet speed helps you confirm if you are getting the bandwidth promised by your internet service provider.
          </p>
        </section>
