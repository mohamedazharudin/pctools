  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 text-left">
      ...
      <div className="p-6 bg-slate-900 border border-slate-800 rounded-2xl text-slate-300 text-sm leading-relaxed space-y-6">
        <section>
          <h3 className="text-lg font-bold text-white mb-2">About Online Speed Test</h3>
          <p>
            This tool measures your real-time download bandwidth by fetching a sample data file from a fast content delivery network. Checking your internet speed helps you confirm if you are getting the bandwidth promised by your internet service provider.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="space-y-3">
            <div>
              <h4 className="font-medium text-slate-200">What does Mbps stand for?</h4>
              <p className="text-xs text-slate-400 mt-0.5">
                Mbps stands for Megabits per second, which is the standard unit used to measure network download speed.
              </p>
            </div>
            <div>
              <h4 className="font-medium text-slate-200">Is this test completely free to use?</h4>
              <p className="text-xs text-slate-400 mt-0.5">
                Yes, this online speed test runs entirely inside your web browser without requiring any software installation.
              </p>
            </div>
          </div>
        </section>
