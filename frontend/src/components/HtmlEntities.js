  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-left">
        ...
        {/* Left Column: Technical Reference Article Container */}
        <div className="lg:col-span-5 p-6 bg-slate-900 border border-slate-800 rounded-2xl text-slate-300 text-sm leading-relaxed space-y-6 shadow-xl">
          <article className="space-y-6">
            <header className="border-b border-slate-800 pb-4">
              <span className="text-xs font-semibold uppercase tracking-wider text-blue-400">Web Development & Encoding</span>
              <h1 className="text-2xl font-bold text-white mt-1">Understanding HTML Character Entities and Symbols</h1>
            </header>

            <section className="space-y-3">
              <h2 className="text-lg font-semibold text-white">1. What Are HTML Entities?</h2>
              <p>
                HTML entities are reserved sequences of characters used to display reserved symbols, non-printable characters, or invisible formatting spaces within browser documents without breaking document markup parsers.
              </p>
              <p>
                When web browsers encounter reserved characters like angle brackets, they interpret them as HTML tags unless properly escaped into entity syntax.
              </p>
            </section>

            <section className="space-y-3">
              <h2 className="text-lg font-semibold text-white">2. Entity Reference Formats</h2>
              <p>
                Character references in HTML documents can be formatted using two distinct standards:
              </p>
              <ul className="list-disc list-inside space-y-2 text-slate-400 pl-1">
                <li>
                  <strong className="text-slate-200">Named Character References:</strong> Short, human-readable aliases such as <code className="text-blue-400">&amp;copy;</code> or <code className="text-blue-400">&amp;amp;</code> defined in standard HTML specifications.
                </li>
                <li>
                  <strong className="text-slate-200">Decimal Numerical References:</strong> Direct references to Unicode code points, written as <code className="text-emerald-400">&amp;#169;</code> or <code className="text-emerald-400">&amp;#38;</code>.
                </li>
                <li>
                  <strong className="text-slate-200">Hexadecimal References:</strong> Unicode code points represented in hex notation using <code className="text-slate-200">&amp;#xA9;</code> syntax.
                </li>
              </ul>
            </section>

            <section className="space-y-3">
              <h2 className="text-lg font-semibold text-white">3. Best Practices for Web Encodings</h2>
              <p>
                Modern web pages rendered with UTF-8 character encoding can display most special characters directly. However, using entity codes remains critical for reserved syntax characters and ensuring fallback cross-browser compatibility across legacy systems.
              </p>
            </section>
          </article>
        </div>

        {/* Right Column: Interactive Search Tool & FAQ */}
