    ...
    <div className="max-w-2xl mx-auto space-y-8 text-left">
      ...
      <div className="p-6 bg-slate-900 border border-slate-800 rounded-2xl text-slate-300 text-sm leading-relaxed space-y-6">
        <section>
          ...
          <p>
            Extracting audio tracks from video files allows you to turn music clips, recorded talks, or video lectures into audio files. 
            This converter processes video streams directly inside your browser to extract the sound channel instantly.
          </p>
        </section>
