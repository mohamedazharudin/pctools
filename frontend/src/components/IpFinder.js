  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <div className="p-6 bg-slate-900 border border-slate-800 rounded-2xl shadow-xl text-white">
        ...
        {loading ? (
          <div className="p-6 text-center text-slate-400 animate-pulse">Fetching IP info...</div>
        ) : ipData ? (
          <div className="space-y-3 text-sm text-slate-300 bg-slate-950 p-4 rounded-xl border border-slate-800">
            ...
            <div className="flex justify-between border-b border-slate-800 pb-2">
              ...
              <span className="text-white">{ipData.city}, {ipData.region}, {ipData.country_name}</span>
            </div>
            <div className="flex justify-between border-b border-slate-800 pb-2">
      ...
      <div className="p-6 bg-slate-900 border border-slate-800 rounded-2xl text-slate-300 text-sm leading-relaxed space-y-6">
        <section>
          ...
          <p>
            An IP (Internet Protocol) address acts as a unique digital identifier assigned to your device whenever you connect to the internet. 
            This online tool displays your public IP address along with estimated geographical location and internet service provider details.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-1.5 text-slate-400">
            <li><strong className="text-slate-200">Network Troubleshooting:</strong> Verify if your internet connection or router setup is working properly.</li>
            <li><strong className="text-slate-200">VPN Verification:</strong> Confirm if your Virtual Private Network is masking your real location.</li>
            <li><strong className="text-slate-200">Security Awareness:</strong> Monitor network location details provided to public web servers.</li>
          </ul>
        </section>
