  ...
  return (
    <div className="max-w-4xl mx-auto text-left space-y-6 sm:space-y-8 overflow-hidden px-1 sm:px-0">
      ...
      <div className="p-6 bg-slate-900 border border-slate-800 rounded-2xl text-slate-300 text-sm leading-relaxed space-y-6">
        <section>
          <h3 className="text-lg font-bold text-white mb-2">About Strong Password Generator</h3>
          <p>
            Create cryptographically secure, random passwords instantly to protect your online accounts against unauthorized access and brute-force attacks.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="space-y-3">
            <div>
              <h4 className="font-medium text-slate-200">Are generated passwords saved anywhere?</h4>
              <p className="text-xs text-slate-400 mt-0.5">
                No. Passwords are generated completely client-side inside your browser and are never sent to any server.
              </p>
            </div>
            <div>
              <h4 className="font-medium text-slate-200">What makes a password strong?</h4>
              <p className="text-xs text-slate-400 mt-0.5">
